      ...
      <div className="max-w-[900px] mx-auto space-y-24 sm:space-y-32">
        ...
        <section className="space-y-8">
          ...
          <p className="text-[17px] sm:text-[21px] text-[var(--text-muted)] font-normal leading-[1.6] max-w-3xl">
            A clean, modern redesign built to make luxury real estate feel effortless.
          </p>
        </section>
        ...
        <section className="space-y-8 pt-8 border-t border-[var(--border-color)]">
          <div className="space-y-4 max-w-3xl">
            ...
            <p className="text-[16px] sm:text-[20px] text-[var(--text-muted)] font-normal leading-[1.6]">
              We rebuilt their entire site. It loads fast, works perfectly on phones, and looks modern.
            </p>
          </div>

          <div className="space-y-6 pt-4 max-w-2xl">
            <div className="flex items-start gap-4">
              <span className="font-mono text-sm sm:text-base font-semibold text-[var(--text-muted)] mt-1">01</span>
              <p className="text-[17px] sm:text-[20px] font-medium text-[var(--text-primary)] leading-[1.5]">
                Three times more buyer inquiries.
              </p>
            </div>
            <div className="flex items-start gap-4">
              <span className="font-mono text-sm sm:text-base font-semibold text-[var(--text-muted)] mt-1">02</span>
              <p className="text-[17px] sm:text-[20px] font-medium text-[var(--text-primary)] leading-[1.5]">
                Under one second load time.
              </p>
            </div>
            <div className="flex items-start gap-4">
              <span className="font-mono text-sm sm:text-base font-semibold text-[var(--text-muted)] mt-1">03</span>
              <p className="text-[17px] sm:text-[20px] font-medium text-[var(--text-primary)] leading-[1.5]">
